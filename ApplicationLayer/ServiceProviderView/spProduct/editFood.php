...
<div class="col-lg-10 col-md-6 mb-6">
  <div class="container"><br>
           ...
           <tr>
            <td></td>
              <td><center><button type="submit" name="update" value="updateFood" class="btn btn-info">UPDATE</button>
              <button type="button" onClick="location.href='spViewFood.php'" class="btn btn-danger">CANCEL</button></center></td>
            </tr>
       </table>
        </form></div>
            </div>
