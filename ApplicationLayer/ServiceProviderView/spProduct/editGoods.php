...
<div class="col-lg-10 col-md-6 mb-6">
  <div class="container"><br>
           ...
           <tr>
            <td></td>
              <td><button type="submit" name="update" value="updateGoods" class="btn btn-info">UPDATE</button></td>
              <td><button type="button" onClick="location.href='spViewGoods.php'" class="btn btn-danger">CANCEL</button></td>
            </tr>
       </table>
        </form></div>
            </div>
