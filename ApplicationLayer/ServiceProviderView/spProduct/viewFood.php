...
<div class="col-lg-10 col-md-6 mb-4">
  <div class="container"><br>
           ...
           <tr>
              <td></td>
              <td><center><button type="button" onClick="location.href='editFood.php?FoodId=<?=$row['id']; ?>'" value="EDIT" class="btn btn-info">EDIT</button>

              <input type="hidden" name="FoodId" value="<?=$row['id']?>"><button type="submit" class="btn btn-danger" name="delete" value="DELETE" onClick="return confirm('Are you SURE you want to delete?')" class="button button2">DELETE</button></center></td>
       </table>
        </form>
            </div></div>
