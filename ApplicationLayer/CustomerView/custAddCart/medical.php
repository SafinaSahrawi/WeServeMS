...
require_once "../../../BusinessServiceLayer/Customercontroller/controller.php";
  ...
  $data = $Medical->viewAllMedical()->fetchAll();
  ?>


<?=template_header('medical')?>
     ...
     <!-- /.col-lg-3 -->
          <div class="col-lg-5 col-md-5 mb-4">
           <div class="cart content-wrapper">
            <br>
            <h1>Medical Categories</h1>
           
            
                <?php foreach ($data as $row): ?>
             <div class="card h-100">
              <a href="productmedical.php?MedicalId=<?=$row['id']?>" method="post" class="medical">
